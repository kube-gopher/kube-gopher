...
Coming from 2 years of hands-on SRE work (Prometheus-based monitoring across bare-metal and cloud, CI/CD pipelines on Alibaba Cloud / AWS), I'm now focused on bringing that operational rigor into the LLM inference stack — where most observability tools still treat GPUs and inference engines as black boxes.

- 🔧 **Currently contributing to:** [Kthena](https://github.com/volcano-sh/kthena) — early contributor focusing on inference scheduling and observability
...
- ✍️ **Writing about:** what I learn while reading source code — [掘金](#) · [dev.to](#) · [知乎](#) · [CSDN](#) 
...
> **Targeting 2027 internship** at AI inference infrastructure teams. If you're working on this stack, I'd love to learn from you.
